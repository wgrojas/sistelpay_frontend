...
export default function Login({ setUserId, setVista, setIdentidad }) {
  ...
  const login = async () => {
    ...
    try {
      ...
      // Guardar ID e identidad del usuario → esto hará que App.jsx muestre Dashboard
      setUserId(res.data.user_id);
      setIdentidad(res.data.identidad);
      ...
      // ❌ Ya no necesitamos esto: setVista("dashboard");
    } catch (error) {
      Swal.fire({
        icon: "error",
        title: "Error",
